...
class SearchResultCell: UITableViewCell {
    ...
    func configureForSearchResult(searchResult: SearchResult) {
        ...
        if searchResult.artistName.isEmpty {
            artistNameLabel.text = NSLocalizedString("Unknown", comment: "Localized string: Unknown artist")
        } else {
            artistNameLabel.text = String(
                format: NSLocalizedString("ARTIST_NAME_LABEL_FORMAT", comment: "Format for artist name label"),
